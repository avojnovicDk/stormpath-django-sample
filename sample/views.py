...
def new_handle_id_site_callback(self, url_response):
    try:
...
funcType = type(Application.handle_id_site_callback)
APPLICATION.handle_id_site_callback = funcType(new_handle_id_site_callback, APPLICATION, Application)
